    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-r from-red-700 via-green-800 to-red-700">
      <main className="flex-grow flex items-center p-8">
        <div className="w-1/2">
          ...
          <Link
            to="/learning"
            className="bg-blue-500 text-white w-40 py-1 rounded-full flex items-center justify-center text-sm transition-transform duration-300 transform hover:-translate-y-2 mb-4"
          >
